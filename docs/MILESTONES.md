...
Status: in Arbeit (Branch `feat/milestone-1`, Stand 2026-05-25 — 6 von 7 Slices fertig, Tests noch offen)
...
- [ ] Solver-Unit-Tests einführen — Slice 6, in Arbeit
